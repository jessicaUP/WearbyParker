...
a = ProductsColor.create!(product_id: 1, color_id: 1, color_name: 'Jet Black')
    a1 = File.open('app/assets/images/plants/philodendron_hope/hover.jpeg')
    a.photohover.attach(io: a1, filename: 'hover.jpeg')
...
f = ProductsColor.create!(product_id: 4, color_id: 2, color_name: 'Butterscotch Tortoise')
